...
* [Berkeley Library - Design Fundamentals: Elements & Principles](https://guides.lib.berkeley.edu/design)
* [Key Elements and Principles of Graphic Design: A Complete Beginner’s Guide](https://www.gdgraphic.com/design-elements-principles-guide)
...
C. For each of the following, decide which of the two fonts is more appropriate and explain why.

    1. A fancy party invitation (Consolas or Caveat)
    2. A kids party invitation (Comic Sans or Times New Roman)
    3. A sign that says "Do Not Enter" (Impact or Lobster)
    4. a business letter (Cambria or Lucida Sans)
    5. a company website (Georgia or Arial)
...
C. Find a poster you like online, then answer the following questions for that poster.

    1. What are 2 or more design principles that you think are well utilized in this poster?
    2. What are 2 elements you would change in this poster? Why? What design principles are these changes related to?
    3. Why do you like this poster?

D. Provide feedback for at least one other student on their compositions.
