...
Design and write a program in a language other than one you used for CSE2110 or CSE1120. The program should solve a real need for you, someone you know, or your community.

Possible examples:

* home chore scheduler
* helper tool such as packing checklist or meal planner
* homework timer or tracker
* converter or calculator
* tournament bracket-builder
* something else

Ensure that your program includes:

* a sketch or plan **before** you start coding, perhaps pseudocode, a flowchart, a sketch, or bullet-point logic notes
